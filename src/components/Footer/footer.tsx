...
<h1 className="text-lg font-semibold">Dine Market</h1>
</div> 
                </a>
            ...
            <LinkGroup header="Support">
              <NavLink link="/#" label="Support Center" />
              <NavLink link="/#" label="Customer Service" />
              <NavLink link="/#" label="Quick Chat" />
              
            </LinkGroup>
            <LinkGroup header="Contatct Us">
            <NavLink link="/#" label="+1 (555) 123-7456" />
              <NavLink link="/#" label="+44 20 7946 0958" />
              <NavLink link="/#" label="+81 3 1234 5678" />
            </LinkGroup>
...
const NavLink = ({ link, label }:{link:string;label:any;}) => {
  return (
    <li>
      <a
        href={link}
